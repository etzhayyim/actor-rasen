...
(def nss '[rasen.murakumo-test rasen.methods.test-cid rasen.methods.test-gene-node
           ...
           rasen.tests.test-publish rasen.tests.test-clinvar rasen.tests.test-ledger-shards rasen.tests.test-clinvar-run rasen.tests.test-kotobase-publish rasen.tests.test-gnomad])
